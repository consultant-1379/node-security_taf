 ...
 * @author enmadmin
 */
public class CertificateIssueNodeNotExistErrorScenariosTestSteps extends NodeSecurityTestCaseHelper {
    
    private static Logger logger = Logger.getLogger(CertificateIssueNodeNotExistErrorScenariosTestSteps.class);

    @TestStep(id = "certificateIssueNodeNotExistErrorTest")
    public void certificateIssueNodeNotExistErrorTest(
            @Input("nodeList") String nodeList,
            @Input("ipAddressList") final String ipAddressList
            ) {

        System.out.println(" \n\n ############# Starting test certificateIssueNodeNotExistErrorTest ############# \n\n");
        logger.info(" \n\n ############# Starting test certificateIssueNodeNotExistErrorTest ############# \n\n");

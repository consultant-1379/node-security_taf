...
public class ResponseDtoWrapper {
     ...
     *  "dtoType": "line",
     *  "value": "OASIS_ERBS05 : LEVEL_1",
     *  "weight": 1
     *  Checks each LineDto value and if it contains a LEVEL_(1/2/3) Char sequence it splits the String, and enters the node name and level into the map
     *
